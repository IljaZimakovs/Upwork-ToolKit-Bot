...
async function scrapeProjects(page) {
    ...
    while (attempt < maxAttempts) {
        try {
            attempt++;
            await page.goto("https://www.upwork.com/nx/search/jobs?amount=500-&category2_uid=531770282580668420,531770282580668419,531770282580668418&location=Americas,Antarctica,Asia,Europe,Oceania&payment_verified=1&sort=recency&t=0,1", { waitUntil: 'networkidle2', timeout: 60000 });
